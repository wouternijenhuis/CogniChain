...
public class RetryHandler(RetryPolicy? policy = null)
{
    private readonly RetryPolicy _policy = policy ?? RetryPolicy.Default;
...
public class RetryException(string message, Exception innerException) : Exception(message, innerException)
{
}
